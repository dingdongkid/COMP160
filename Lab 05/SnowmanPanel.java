...
public class SnowmanPanel extends JPanel{
  ...
  public void paintComponent (Graphics page)
  {
    ...
    page.fillOval (260, -40, 80, 80);  // sun (right side)
    ...
    page.fillOval (MID - 3, TOP + 65, 6, 6);  //button 1
    page.fillOval (MID - 3, TOP + 45, 6, 6);  //button 1
    ...
    page.drawString ("Nick Dong", 10, 20); //nametag
  }
}
